        ...
        <div class="bg-[#0a2c37] p-8 rounded-3xl shadow-2xl border border-gray-700/30 backdrop-blur-sm w-full max-w-md relative overflow-hidden">
            ...
            <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 bg-gray-100 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-accent" required>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-4 py-3 bg-gray-100 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-accent" required>
                </div>
            ...
            <div class="text-center text-sm text-gray-300 mt-4">
                ...
                <a href="{{ route('login') }}" class="text-accent hover:underline ml-1">Sign in</a>
            </div>
            </form>
        </div>
    </div>
